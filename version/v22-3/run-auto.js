...
function changeWayV20step() {
    ...
    var color12 = colors[31] != undefined ? colors[31] : '';
    var color13 = colors[11] != undefined ? colors[11] : '';

    var color7 = colors[19] != undefined ? colors[19] : '';

    if (color1 == color2 && color3 == color4 && color5 == color6 && color8 == color9 && color10 == color11 && color12 == color13) {
        if (color7 == 'x') {
            tem.lastChoose == 'd'
        }
        if (color7 == 'd') {
